...
Serial.println(identifier, HEX);
  ...
  tft.print("*");
   ...
   tft.setTextColor(YELLOW);
  tft.setTextSize(2);
  tft.setCursor(293, 50);
  tft.print("*");

   tft.setTextColor(RED);
  tft.setTextSize(3);
  tft.setCursor(37, 50);
  tft.print("SCOPE_INFINITY");
  ...
  tft.print("PBL --PROJECT");
  tft.setTextColor(GREEN);
  tft.setTextSize(2);
  tft.setCursor(60, 180);
  tft.print("PILLAI COLLEGE OF");
...
if (trig_mode != TRIG_SCAN) {
  ...
  tft.println("T/DIV");
     if (p.y > 250 && p.y < 320 && p.x > 50 && p.x < 90) {
     Serial.println("T/DIV");
...
//v/div button
  ...
  tft.println("V/DIV");
     if (p.y > 250 && p.y < 320 && p.x > 95 && p.x < 115) {
...
//START
  ...
  tft.println("START");
     if (p.y > 250 && p.y < 320 && p.x > 145 && p.x < 164) {
...
//STOP
  ...
  tft.println("FREEZE");
     if (p.y > 250 && p.y < 320 && p.x > 174 && p.x < 189) {
